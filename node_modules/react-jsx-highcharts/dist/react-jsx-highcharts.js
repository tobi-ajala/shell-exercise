  ...
  var ChartProvider = function (_Component) {
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(ChartProvider, [{
      ...
      value: function render() {
        ...
        var getBoundChartMethod = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9__utils_boundContextHelper__["a" /* default */])(chart, chart);
  ...
  var AxisProvider = function (_Component) {
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(AxisProvider, [{
      ...
      value: function render() {
        ...
        var getBoundAxisMethod = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9__utils_boundContextHelper__["a" /* default */])(this.props.getChart(), axis);

        var update = getBoundAxisMethod(axis && axis.update);
        var remove = getBoundAxisMethod(axis && axis.remove);
        var addPlotBand = getBoundAxisMethod(axis && axis.addPlotBand);
        var removePlotBand = getBoundAxisMethod(axis && axis.removePlotBand);
        var addPlotLine = getBoundAxisMethod(axis && axis.addPlotLine);
        var removePlotLine = getBoundAxisMethod(axis && axis.removePlotLine);
        var getExtremes = getBoundAxisMethod(axis && axis.getExtremes);
        var setExtremes = getBoundAxisMethod(axis && axis.setExtremes);
  ...
  var SeriesProvider = function (_Component) {
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(SeriesProvider, [{
      ...
      value: function render() {
        ...
        var getBoundSeriesMethod = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10__utils_boundContextHelper__["a" /* default */])(this.props.getChart(), series);

        var update = getBoundSeriesMethod(series && series.update);
        var remove = getBoundSeriesMethod(series && series.remove);
        var setData = getBoundSeriesMethod(series && series.setData);
        var setVisible = getBoundSeriesMethod(series && series.setVisible);
